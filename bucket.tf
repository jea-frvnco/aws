...
resource "aws_s3_bucket" "website_bucket" {
  bucket = "website-bucket-jean-${random_id.bucket.hex}"

  tags = {
    Name = "website-bucket-jean-${random_id.bucket.hex}"
  }
}
